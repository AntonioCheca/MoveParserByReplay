...
class FrameMeterColumn:
    ...
    THRESHOLD_PAST_PROBABILITY = 0.5
    ...
    def transform_from_past_to_present(self) -> Self:
        ...
        return FrameMeterColumn(self.column_position, new_p1_state, new_p2_state)
    ...
    def get_differences_with_other(self, other: Self) -> List[str]:
        ...
        self_p1 = self.p1_state.get_most_likely_possibility()
        other_p1 = other.p1_state.get_most_likely_possibility()
        if self_p1 != other_p1:
            differences.append('P1 State, {} vs {}'.format(str(self_p1), str(other_p1)))

        self_p2 = self.p2_state.get_most_likely_possibility()
        other_p2 = other.p2_state.get_most_likely_possibility()
        if self_p2 != other_p2:
